...
# Grid Logik wird nach jeder Candle akt., muss aber nach jedem Trade aktualisiert werden, um den aktuellen Preis zu berücksichtigen.
# Grid Bot Version 22.0 - Stand: 2025-07-17
...
BOT_VERSION = f"bot.py – Version 22.1 – Stand: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}"
